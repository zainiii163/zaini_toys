...
const productImages: Record<string, string> = {
  ...
  'lego-star-wars-imperial-cruiser': 'https://images.unsplash.com/photo-1611516491426-03025e6043c8?w=600&h=600&fit=crop',
  'lego-technic-porsche': 'https://images.unsplash.com/photo-1587654780291-39c9404d7dd0?w=600&h=600&fit=crop',
  'lego-friends-vet-clinic': 'https://images.unsplash.com/photo-1596464716127-f2a82984de30?w=600&h=600&fit=crop',
  'hot-wheels-track-set': 'https://images.unsplash.com/photo-1581235707960-23b768784c07?w=600&h=600&fit=crop',
  'hot-wheels-gift-pack': 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=600&fit=crop',
  'barbie-fashion-wardrobe': 'https://images.unsplash.com/photo-1559715541-5daf8a0296d0?w=600&h=600&fit=crop',
  'barbie-dancing-doll': 'https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=600&h=600&fit=crop',
  'kids-bicycle': 'https://images.unsplash.com/photo-1571068316344-75bc76f77890?w=600&h=600&fit=crop',
  'kids-scooter': 'https://images.unsplash.com/photo-1517649763962-0c623066013b?w=600&h=600&fit=crop',
  'drone-for-kids': 'https://images.unsplash.com/photo-1507582020474-9a35b7d455d9?w=600&h=600&fit=crop',
  'robot-kit': 'https://images.unsplash.com/photo-1629236714692-9dddb8596d7f?w=600&h=600&fit=crop',
  'monopoly-classic': 'https://images.unsplash.com/photo-1632501641765-e568d28b0015?w=600&h=600&fit=crop',
  'puzzle-1000-piece': 'https://images.unsplash.com/photo-1606503153255-59d8b2e4b9e4?w=600&h=600&fit=crop',
  'baby-activity-center': 'https://images.unsplash.com/photo-1590759668628-ad03996511c4?w=600&h=600&fit=crop',
  'baby-rattles-set': 'https://images.unsplash.com/photo-1545486332-9e0999c535b2?w=600&h=600&fit=crop',
  'slime-kit': 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=600&h=600&fit=crop',
  'jewelry-making-kit': 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=600&h=600&fit=crop',
  'coding-robot': 'https://images.unsplash.com/photo-1588072432836-e10032774350?w=600&h=600&fit=crop',
  'science-kit': 'https://images.unsplash.com/photo-1629236714692-9dddb8596d7f?w=600&h=600&fit=crop',
  'teddy-bear': 'https://images.unsplash.com/photo-1559715541-5daf8a0296d0?w=600&h=600&fit=crop',
  'dinosaur-plush': 'https://images.unsplash.com/photo-1530325553241-4d6e3c34ece0?w=600&h=600&fit=crop',
};
...
const products = [
  ...
  // === NEW PRODUCTS BELOW ===
  { name: 'LEGO Star Wars Imperial Light Cruiser', slug: 'lego-star-wars-imperial-cruiser', sku: 'LEG-SW-002', price: 16999, salePrice: 14999, description: 'Build Moff Gideon\'s Imperial Light Cruiser with 1,336 pieces! Includes The Mandalorian, Grogu, and Dark Trooper figures.', shortDescription: '1336-piece Star Wars cruiser set', brand: 'lego', category: 'building-toys', ageMin: 10, ageMax: 99, stock: 12, isFeatured: true, isNewArrival: true, tags: ['lego', 'star-wars', 'mandalorian', 'grogu'], material: ['Plastic'], color: ['Black', 'Gray', 'Red'] },
  { name: 'LEGO Technic Porsche 911 GT3 RS', slug: 'lego-technic-porsche', sku: 'LEG-TC-001', price: 27999, description: 'The ultimate LEGO Technic supercar with 2,704 pieces. Features working flat-six engine, opening doors, and authentic detailing.', shortDescription: '2704-piece Technic supercar', brand: 'lego', category: 'building-toys', ageMin: 12, ageMax: 99, stock: 6, isFeatured: true, tags: ['lego', 'technic', 'porsche', 'supercar'], material: ['Plastic'], color: ['Orange', 'Black'] },
  { name: 'LEGO Friends Heartlake City Vet Clinic', slug: 'lego-friends-vet-clinic', sku: 'LEG-FR-001', price: 5999, description: 'Help pets at the Heartlake City Vet Clinic! Includes vet office, grooming area, and animal figures.', shortDescription: 'Vet clinic playset with figures', brand: 'lego', category: 'building-toys', ageMin: 6, ageMax: 12, stock: 28, isNewArrival: true, tags: ['lego', 'friends', 'vet', 'animals'], material: ['Plastic'], color: ['Pink', 'Purple', 'White'] },
  { name: 'Hot Wheels Multi-Level Track Set', slug: 'hot-wheels-track-set', sku: 'HW-TS-001', price: 6499, description: 'Epic multi-level Hot Wheels track with loop, boosters, and crash zone! Connects to other Hot Wheels track sets.', shortDescription: 'Multi-level track with loop', brand: 'hot-wheels', category: 'vehicles-rc', ageMin: 5, ageMax: 12, stock: 18, isBestSeller: true, tags: ['hot-wheels', 'track', 'loop', 'racing'], material: ['Plastic'], color: ['Orange', 'Blue', 'Black'] },
  { name: 'Hot Wheels 50-Car Gift Pack', slug: 'hot-wheels-gift-pack', sku: 'HW-GP-001', price: 8999, salePrice: 7499, description: 'The ultimate gift for Hot Wheels fans! 50 unique die-cast cars in a collectible gift box.', shortDescription: '50 die-cast cars gift set', brand: 'hot-wheels', category: 'vehicles-rc', ageMin: 3, ageMax: 15, stock: 20, isBestSeller: true, isFeatured: true, tags: ['hot-wheels', 'gift', 'die-cast', 'collection'], material: ['Die-cast Metal'], color: ['Multicolor'] },
  { name: 'Barbie Fashion Wardrobe Playset', slug: 'barbie-fashion-wardrobe', sku: 'BAR-FW-001', price: 4999, description: 'Complete fashion wardrobe with 15+ accessories, hangers, and a garment rack. Mix and match outfits!', shortDescription: 'Fashion wardrobe with 15+ accessories', brand: 'barbie', category: 'dolls-plush', ageMin: 3, ageMax: 10, stock: 22, isNewArrival: true, tags: ['barbie', 'fashion', 'wardrobe', 'accessories'], material: ['Plastic', 'Fabric'], color: ['Pink', 'White', 'Gold'] },
  { name: 'Barbie Dancing & Walking Doll', slug: 'barbie-dancing-doll', sku: 'BAR-DD-001', price: 5999, description: 'Barbie doll that walks and dances to 3 fun songs! Press her hand to activate movement and music.', shortDescription: 'Interactive dancing Barbie doll', brand: 'barbie', category: 'dolls-plush', ageMin: 3, ageMax: 8, stock: 30, isFeatured: true, tags: ['barbie', 'dancing', 'interactive', 'music'], material: ['Plastic', 'Fabric'], color: ['Pink', 'Purple'] },
  { name: 'Kids Learning Bicycle 16"', slug: 'kids-bicycle', sku: 'OUT-BK-001', price: 12999, salePrice: 10999, description: 'Durable 16-inch children\'s bicycle with training wheels, bell, and adjustable seat. Perfect for ages 4-8.', shortDescription: '16-inch bike with training wheels', brand: 'funskool', category: 'outdoor-toys', ageMin: 4, ageMax: 8, stock: 15, isFeatured: true, tags: ['bicycle', 'outdoor', 'riding', 'kids'], metal: ['Steel'], color: ['Red', 'Blue'], material: ['Steel', 'Rubber'] },
  { name: 'Kids Kick Scooter 3-Wheel', slug: 'kids-scooter', sku: 'OUT-SC-001', price: 4999, description: 'Stable 3-wheel kick scooter with adjustable handlebar and non-slip deck. LED wheels light up while riding!', shortDescription: '3-wheel scooter with LED wheels', brand: 'funskool', category: 'outdoor-toys', ageMin: 3, ageMax: 8, stock: 25, isNewArrival: true, isBestSeller: true, tags: ['scooter', 'outdoor', 'riding', 'led'], material: ['Aluminum', 'Plastic'], color: ['Blue', 'Pink', 'Green'] },
  { name: 'Tello Mini Drone for Kids', slug: 'drone-for-kids', sku: 'ELEC-DR-001', price: 9999, description: 'Easy-to-fly mini drone with camera, programmable flight modes, and 13-minute battery life. Safe for beginners!', shortDescription: 'Mini drone with camera and programming', brand: 'funskool', category: 'electronic-toys', ageMin: 8, ageMax: 14, stock: 14, isFeatured: true, isNewArrival: true, tags: ['drone', 'camera', 'flying', 'tech'], material: ['Plastic', 'Electronics'], color: ['White', 'Black'] },
  { name: 'mBot2 Coding Robot Kit', slug: 'robot-kit', sku: 'ELEC-RK-001', price: 14999, description: 'Build and program your own robot! Supports Scratch, Python, and mBlock. Includes sensors and modules.', shortDescription: 'Programmable robot building kit', brand: 'funskool', category: 'electronic-toys', ageMin: 8, ageMax: 14, stock: 10, isFeatured: true, tags: ['robot', 'coding', 'stem', 'programming'], material: ['Metal', 'Electronics'], color: ['Blue', 'Black'] },
  { name: 'Monopoly Classic Board Game', slug: 'monopoly-classic', sku: 'BG-MON-001', price: 3999, description: 'The classic Monopoly board game! Buy, sell, and trade properties. Family game night essential.', shortDescription: 'Classic property trading game', brand: 'funskool', category: 'board-games', ageMin: 8, ageMax: 99, stock: 45, isBestSeller: true, tags: ['monopoly', 'board-game', 'family', 'classic'], material: ['Cardboard', 'Plastic'], color: ['Multicolor'] },
  { name: 'Jigsaw Puzzle 1000 Pieces - World Map', slug: 'puzzle-1000-piece', sku: 'BG-PZ-001', price: 1999, description: 'Beautiful 1000-piece world map puzzle. Finished size 68x49cm. Premium quality with minimal puzzle dust.', shortDescription: '1000-piece world map puzzle', brand: 'funskool', category: 'board-games', ageMin: 10, ageMax: 99, stock: 35, tags: ['puzzle', 'jigsaw', 'world-map', 'family'], material: ['Cardboard'], color: ['Multicolor'] },
  { name: 'Baby Activity Center with Tray', slug: 'baby-activity-center', sku: 'BB-AC-001', price: 7999, salePrice: 6499, description: '360-degree rotating activity center with detachable toy tray, music, and lights. Grows with your baby!', shortDescription: 'Rotating activity center with music', brand: 'fisher-price', category: 'baby-toys', ageMin: 0, ageMax: 2, stock: 18, isNewArrival: true, tags: ['baby', 'activity', 'music', 'lights'], material: ['Plastic'], color: ['Blue', 'Green', 'Yellow'] },
  { name: 'Baby Rattles & Teethers Set', slug: 'baby-rattles-set', sku: 'BB-RT-001', price: 1499, description: 'Set of 6 colorful rattles and teethers. BPA-free, easy to grip, and perfect for sensory development.', shortDescription: '6-piece rattle and teether set', brand: 'fisher-price', category: 'baby-toys', ageMin: 0, ageMax: 1, stock: 60, tags: ['baby', 'rattle', 'teether', 'sensory'], material: ['Plastic', 'Silicone'], color: ['Multicolor'] },
  { name: 'DIY Slime Making Kit (50+ Supplies)', slug: 'slime-kit', sku: 'AC-SL-001', price: 2499, description: 'Create 15+ types of slime with glitter, beads, and more! Includes glue, activator, and storage containers.', shortDescription: 'Slime making kit with 50+ supplies', brand: 'crayola', category: 'arts-crafts', ageMin: 6, ageMax: 14, stock: 40, isBestSeller: true, tags: ['slime', 'crafts', 'diy', 'creative'], material: ['Non-toxic compound'], color: ['Multicolor'] },
  { name: 'Jewelry Making Kit for Kids', slug: 'jewelry-making-kit', sku: 'AC-JM-001', price: 2999, description: 'Make your own bracelets, necklaces, and rings! Includes 500+ beads, charms, and elastic cords.', shortDescription: '500+ piece jewelry craft kit', brand: 'crayola', category: 'arts-crafts', ageMin: 6, ageMax: 12, stock: 30, isNewArrival: true, tags: ['jewelry', 'crafts', 'beads', 'creative'], material: ['Plastic', 'Elastic'], color: ['Multicolor'] },
  { name: 'Matatalab Coding Robot Set', slug: 'coding-robot', sku: 'STEM-CR-001', price: 11999, description: 'Screen-free coding robot for kids! Learn programming through hands-on play with tangible blocks.', shortDescription: 'Screen-free coding robot', brand: 'funskool', category: 'educational-toys', ageMin: 4, ageMax: 9, stock: 16, isFeatured: true, tags: ['coding', 'robot', 'stem', 'screen-free'], material: ['Plastic', 'Electronics'], color: ['White', 'Blue'] },
  { name: 'National Geographic Science Kit', slug: 'science-kit', sku: 'STEM-SK-001', price: 3999, description: '45+ science experiments! Grow crystals, erupt volcanoes, and learn about geology. Includes full-color guide.', shortDescription: '45+ science experiments kit', brand: 'funskool', category: 'educational-toys', ageMin: 8, ageMax: 14, stock: 22, isBestSeller: true, tags: ['science', 'experiments', 'stem', 'geology'], material: ['Various'], color: ['Multicolor'] },
  { name: 'Gund Classic Teddy Bear 12"', slug: 'teddy-bear', sku: 'PL-TB-001', price: 3499, description: 'Adorable 12-inch classic teddy bear with soft plush fur and embroidered features. Premium quality, huggable friend!', shortDescription: '12-inch soft plush teddy bear', brand: 'funskool', category: 'dolls-plush', ageMin: 0, ageMax: 99, stock: 50, isBestSeller: true, tags: ['teddy', 'plush', 'stuffed', 'classic'], material: ['Soft Plush', 'Polyester Fill'], color: ['Brown'] },
  { name: 'Giant Dinosaur Plush - T-Rex 24"', slug: 'dinosaur-plush', sku: 'PL-DN-001', price: 5999, salePrice: 4999, description: 'Life-sized 24-inch T-Rex plush toy with realistic detailing. Super soft and perfect for dinosaur lovers!', shortDescription: '24-inch T-Rex stuffed animal', brand: 'funskool', category: 'dolls-plush', ageMin: 3, ageMax: 99, stock: 20, isNewArrival: true, isFeatured: true, tags: ['dinosaur', 'plush', 't-rex', 'stuffed'], material: ['Soft Plush', 'Polyester Fill'], color: ['Green', 'Brown'] },
];
...
const banners = [
  ...
  { title: 'New Arrivals Weekly', subtitle: 'Fresh toys every week', link: '/shop', linkType: 'custom', position: 'hero', sortOrder: 3, isActive: true, image: { url: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=1200&h=500&fit=crop', publicId: 'banner-new-arrivals' } },
];
