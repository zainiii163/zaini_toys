...
COPY --from=build-api /app/packages/config/dist /app/packages/config/dist
COPY --from=build-api /app/packages/types/dist /app/packages/types/dist
COPY --from=build-api /app/packages/validation/dist /app/packages/validation/dist
COPY --from=build-api /app/packages/utils/dist /app/packages/utils/dist
